...
% it_outter_fin = 3;
%
% it_inner_cur = it_outter_fin
% it_outter_cur = it_inner_fin
%
% ar_it_cols_idx = 1:1:(it_inner_fin*it_outter_fin)
% ar_it_cols_inner_dim = repmat(1:it_inner_cur, [it_outter_cur, 1])
% ar_it_cols_inner_dim(:)'
%
% mt_it_cols_idx = reshape(ar_it_cols_idx, [it_inner_cur, it_outter_cur])'
% mt_it_cols_idx(:)'
